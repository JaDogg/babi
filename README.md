...
-  `commit`      Open the commitizen commit TUI
...
-  `fm`          Open the two-pane file manager
-  `gen`         Generate UUIDs, passwords, and random strings
-  `hash`        Hash files or strings
-  `help`        Help about any command
-  `hex`         Open the hex editor
-  `log`         Interactive git log viewer
...
-  `stash`       Interactive git stash manager
-  `sync`        Open the file-sync TUI
